...
class GUI_collection():
    ...
    def __init__(self, root_tk):
        ...
        self.ordernotes=ctk.CTkEntry(master=root_tk,placeholder_text="ORDER NOTES:",corner_radius=10,height=100,width=250,font=placeholder_font,border_width=0)
        self.ordernotes.place(relx=0.15,rely=0.3)

        self.customernotes=ctk.CTkEntry(master=root_tk,placeholder_text="CUSTOMER NOTES:",font=placeholder_font,corner_radius=10,height=100,width=250,border_width=0)
        self.customernotes.place(relx=0.55,rely=0.3)
